...
(function() {
    ...
    var CONFIG = {
        ...
        cnUrls: {
            sfw: 'https://testingcf.jsdelivr.net/gh/sanshui19516/Hot-Update-World-Book-Illustrations@main/%E6%8E%8C%E4%B8%AD%E7%9A%84%E7%BE%8E%E6%AF%8D/SFW.txt',
            nsfw: 'https://testingcf.jsdelivr.net/gh/sanshui19516/Hot-Update-World-Book-Illustrations@main/%E6%8E%8C%E4%B8%AD%E7%9A%84%E7%BE%8E%E6%AF%8D/NSFW.txt',
            rules: 'https://testingcf.jsdelivr.net/gh/sanshui19516/Hot-Update-World-Book-Illustrations@main/%E6%8E%8C%E4%B8%AD%E7%9A%84%E7%BE%8E%E6%AF%8D/rules.txt'
        },
        globalUrls: {
            sfw: 'https://cdn.jsdelivr.net/gh/sanshui19516/Hot-Update-World-Book-Illustrations@main/%E6%8E%8C%E4%B8%AD%E7%9A%84%E7%BE%8E%E6%AF%8D/SFW.txt',
            nsfw: 'https://cdn.jsdelivr.net/gh/sanshui19516/Hot-Update-World-Book-Illustrations@main/%E6%8E%8C%E4%B8%AD%E7%9A%84%E7%BE%8E%E6%AF%8D/NSFW.txt',
            rules: 'https://cdn.jsdelivr.net/gh/sanshui19516/Hot-Update-World-Book-Illustrations@main/%E6%8E%8C%E4%B8%AD%E7%9A%84%E7%BE%8E%E6%AF%8D/rules.txt'
        },
        popup: {
            title: '掌中的美母CG插图更新',
            question: '请选择更新节点：',
        ...
        wizardShownKey: 'zhangzhong_meimu_cg_update_wizard_shown'
    };
    // ─── 配置结束 ──────────────────────────────────────────────────
    ...
    function showToast(text) {
        if (typeof toastr !== 'undefined') {
            ...
            console.log('[掌中的美母CG更新] ' + text);
        }
    }

    function log(msg) { console.log('[掌中的美母CG更新] ' + msg); }
    ...
    function showWizardPopup() {
        ...
        var html = `
            ...
            ">
                ...
                <div style="height:1px;background:rgba(255,215,180,0.15);margin:12px 0 16px;"></div>
                <div style="
                    font-size: 14px;
                    color: #f0e6d8;
                    line-height: 1.8;
    ...
    // ─── 手动 API（调试用） ──────────────────────────────────────
    window.resetZhangzhongCGUpdate = function() {
        clearWizardShown();
        isPopupShowing = false;
        showToast('✅ 已重置');
        setTimeout(function() {
    ...
    window.forceZhangzhongCGUpdate = function() {
        clearWizardShown();
        isPopupShowing = false;
        showWizardPopup();
    };
