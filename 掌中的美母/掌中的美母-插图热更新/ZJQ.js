// ============================================================
// 加载器：玩家可自己切换国内/国际
// 加载：ZZMM8.js（插图正则加载器）、ZZMM1.js（CG热更新）、
//       ZZMM2.js（事件控制器）、ZZMM3.js（CG切换）
// ============================================================
...
// 1. 插图正则加载器（内部会自己 fetch ZZMM.json 并注入正则）
import(BASE_URL + 'ZZMM8.js');

// 2. 其他 JS 模块
import(BASE_URL + 'ZZMM1.js');   // CG热更新
import(BASE_URL + 'ZZMM2.js');   // 事件控制器
import(BASE_URL + 'ZZMM3.js');   // CG切换
