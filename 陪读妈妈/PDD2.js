// ============================================================
// 加载器：玩家可自己切换国内/国际
// 加载：PD1.js（剧情推进）、PD2.js（插图切换）、PD3.js（插图热更新）
// ============================================================
...
// 动态加载功能脚本
import(BASE_URL + 'PD1.js');   // 剧情推进
import(BASE_URL + 'PD5.js');   // 插图切换
import(BASE_URL + 'PD4.js');   // 插图热更新
...
const storyName = '陪读妈妈';
const switchBtnName = '🌐 切换节点（陪读妈妈）';
