...
(function() {
    ...
    var CONFIG = {
        ...
        bgImage: 'https://testingcf.jsdelivr.net/gh/sanshui19516/Hot-Update-World-Book-Illustrations@main/%E3%82%AB%E3%83%A9%E3%83%95%E3%83%AB%E3%81%AA%E8%91%89%EF%BC%9A%E5%8F%AA%E6%98%AF%E5%85%84%E5%A6%B9%E7%9A%84%E6%97%A5%E5%B8%B8/%E6%9D%82/rgx.jpg',
        notifImage: 'https://testingcf.jsdelivr.net/gh/sanshui19516/CG@main/%E5%BC%B9%E7%AA%97.png',
        wizardShownKey: 'changxuchuan_cg_update_wizard_shown'
    };
    // ─── 配置结束 ──────────────────────────────────────────────────
    ...
    function showToast(text) {
        if (typeof toastr !== 'undefined') {
            ...
            console.log('[长须川兄妹CG更新] ' + text);
        }
    }

    function log(msg) { console.log('[长须川兄妹CG更新] ' + msg); }
    ...
    // ─── 手动 API（调试用） ──────────────────────────────────────
    window.resetChangxuchuanCGUpdate = function() {
        clearWizardShown();
        isPopupShowing = false;
        showToast('✅ 已重置');
        setTimeout(function() {
    ...
    window.forceChangxuchuanCGUpdate = function() {
        clearWizardShown();
        isPopupShowing = false;
        showWizardPopup();
    };
